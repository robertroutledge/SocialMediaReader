...
//            string url = String.Format("https://graph.facebook.com/me?fields=id,name,likes,birthday&access_token={0}",accesstoken.Value);
...
//                postss posts = new Models.SocialMedia.Facebook.postss(jsonObj);
//                ViewBag.JSON = result;
//                return View(posts);
//            }
